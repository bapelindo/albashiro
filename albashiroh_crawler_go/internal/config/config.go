...
func Load() *Config {
	return &Config{
		...
		OllamaModel:          getEnv("OLLAMA_MODEL", "albashiroh-crawler"),
		...
		BackupDir:  getEnv("BACKUP_DIR", "c:\\apache\\htdocs\\albashiroh\\scraped_data\\backup"),
		StreamDir:  getEnv("STREAM_DIR", "c:\\apache\\htdocs\\albashiroh\\scraped_data\\backup\\stream"),
		MonitorDir: getEnv("MONITOR_DIR", "c:\\apache\\htdocs\\albashiroh\\scraped_data\\monitor"),
