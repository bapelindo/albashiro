...
import (
	...
	"albashiroh_crawler/internal/filters"
	"albashiroh_crawler/internal/monitor"
	"albashiroh_crawler/internal/ollama"
...
func (s *Scraper) processURL(ctx context.Context, targetURL string) {
	...
	// 2. Store full content → used for albashiroh LLM context
