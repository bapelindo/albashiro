...
-- Complete Database Schema with Reminder System
-- =====================================================
...
(1, 'Ustadz Ahmad Fadhil', 'M.Psi., CH.t., CHt-CI', 'Hipnoterapi Spiritual & Trauma Healing', 'therapist-1.jpg', 
...
(2, 'Dr. Siti Aminah', 'S.Psi., M.Psi., CH.t.', 'Konseling Keluarga & Anak-Anak', 'therapist-2.jpg',
...
(1, 'Administrator', 'admin@albashiro.com', '$2y$12$Nb6Rz7xdDzpSXqNiKxg.z.24u7SOCmuGt/nTqY4IZOKRutOLWDjg6', 'admin', 1);
...
1, 'Edukasi', 'hipnoterapi,islami,kesehatan mental', 'published', NOW()),
...
1, 'Tips Kesehatan', 'kecemasan,anxiety,mental health', 'published', NOW()),
...
1, 'Tips', 'terapis,hipnoterapi,tips', 'published', NOW());
...
SELECT 'Database created successfully!' AS status,
       'All tables with reminder system integrated' AS message,
